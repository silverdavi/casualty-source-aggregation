...
n=200,000 importance-sampled draws; effective sample size 4,260._

## TL;DR

| Quantity | Posterior median | 95% credible interval |
|---|---:|---:|
| Militant share of all Gaza dead, q | **2.0%** | [1.4%, 2.8%] |
| Militants killed (all sides, Gaza) | **1,627** | [1,061, 2,509] |
| Civilian adult males killed | **32,343** | [26,115, 41,376] |
| Women + children killed | **47,834** | [38,674, 61,213] |
| Total direct deaths (true) | **81,850** | [66,226, 104,565] |
| Total direct deaths (MoH-reported) | **69,384** | [60,691, 79,083] |
| Civilian:militant ratio (incl. children) | **49×** | [35×, 72×] |
| Civilian:militant ratio (adult-only) | **20×** | [14×, 30×] |
...
| **This spatial simulator** | **2.0%** | **1,627** |
...
- **q (militant share of dead):** median **2.0%**, 95 % CI [1.4%, 2.8%].
- **Militants killed in Gaza:** median **1,627**, 95 % CI [1,061, 2,509].
- **Civilian adult males killed:** median **32,343**, 95 % CI [26,115, 41,376].
- **Women + children killed:** median **47,834**, 95 % CI [38,674, 61,213].
- **True total direct dead:** median **81,850**, 95 % CI [66,226, 104,565].
- **MoH-reported total:** median **69,384**, fits MoH ≈ 70 k.
- **Civilian:militant ratio (incl. kids):** **49×**, 95 % CI [35×, 72×].
- **Civilian:militant ratio (adult-only — the strict-skeptic version):** **20×**, 95 % CI [14×, 30×].
...
- μ_M near 1.0 (no exposure differential) ⇒ q ≈ **2.0%** (97.5th pct ≈ 2.8%).
- μ_M near 2.5 (strong differential) ⇒ q ≈ **2.0%**.
