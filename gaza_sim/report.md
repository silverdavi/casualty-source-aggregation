...
n=200,000 importance-sampled draws; effective sample size 3,475._

## TL;DR

| Quantity | Posterior median | 95% credible interval |
|---|---:|---:|
| Militant share of all Gaza dead, q | **2.2%** | [1.5%, 3.0%] |
| Militants killed (all sides, Gaza) | **1,776** | [1,125, 2,684] |
| Civilian adult males killed | **30,250** | [24,496, 38,438] |
| Women + children killed | **49,890** | [40,466, 63,350] |
| Total direct deaths (true) | **81,890** | [66,413, 103,974] |
| Total direct deaths (MoH-reported) | **69,454** | [60,650, 79,195] |
| Civilian:militant ratio (incl. children) | **45×** | [32×, 66×] |
| Civilian:militant ratio (adult-only) | **17×** | [12×, 25×] |
...
| **This spatial simulator** | **2.2%** | **1,776** |
...
- **q (militant share of dead):** median **2.2%**, 95 % CI [1.5%, 3.0%].
- **Militants killed in Gaza:** median **1,776**, 95 % CI [1,125, 2,684].
- **Civilian adult males killed:** median **30,250**, 95 % CI [24,496, 38,438].
- **Women + children killed:** median **49,890**, 95 % CI [40,466, 63,350].
- **True total direct dead:** median **81,890**, 95 % CI [66,413, 103,974].
- **MoH-reported total:** median **69,454**, fits MoH ≈ 70 k.
- **Civilian:militant ratio (incl. kids):** **45×**, 95 % CI [32×, 66×].
- **Civilian:militant ratio (adult-only — the strict-skeptic version):** **17×**, 95 % CI [12×, 25×].
