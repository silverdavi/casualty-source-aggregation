...
\begin{claim}
For independent unbiased sources with known variances $\sigma_i^2$ (with estimated $\hat\sigma_i^2$ the optimality holds conditionally on the variance estimates provided they are independent of the point estimates, and asymptotically provided the estimates are consistent, under standard regularity), the estimator
\[
